...
export default async function SmartMatcherPage({
  ...
  const faqItems = [
    {
      question: "What is the Matter protocol in smart home systems?",
      answer: "Matter is a royalty-free connectivity standard that unifies smart home ecosystems (Google Home, Apple Home, Amazon Alexa) allowing devices to communicate locally, quickly, and securely across brands."
    },
    {
      question: "How does this matcher tool help me choose smart devices?",
      answer: "This tool filters smart appliances based on your exact priorities including eco-friendly energy ratings, senior-friendly setup, and existing voice assistant ecosystems."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF5] py-12 px-6">
      <UnifiedStructuredData
        ...
        pageDescription={'Find premium smart home devices matching your ecosystem.'}
        locale={locale}
