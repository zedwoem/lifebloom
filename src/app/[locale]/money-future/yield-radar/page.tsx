...
export default async function YieldRadarPage({
  ...
  const faqItems = [
    {
      question: locale === 'id' 
        ? "Bagaimana Yield Radar membantu saya memilih investasi yang aman?" 
        : "How does the Yield Radar help me choose safe investments?",
      answer: locale === 'id'
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF5] py-12 px-6">
      <UnifiedStructuredData
        ...
        pageTitle={locale === 'id' ? 'Yield Radar' : 'Real-Time Yield Radar'}
