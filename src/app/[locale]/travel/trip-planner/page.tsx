...
export default async function TripPlannerPage({
  ...
  const faqItems = [
    {
      question: locale === 'id' 
        ? "Bagaimana kalkulator anggaran perjalanan ini membantu perencanaan saya?" 
        : "How does this travel budget planner help my trip planning?",
      answer: locale === 'id'
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF5] py-12 px-6">
      <UnifiedStructuredData
        ...
        pageTitle={locale === 'id' ? 'Perencana Anggaran Perjalanan' : 'Accessible Trip Planner'}
