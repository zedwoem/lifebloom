...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: titles[locale] || titles.en,
      description: descriptions[locale] || descriptions.en,
      url: `${baseUrl}/${locale}/home-living/budget-renovator`,
      type: 'website',
      images: [
        {
          url: ogImage,
...
export default async function BudgetRenovatorPage({
  ...
  const faqItems = [
    {
      question: locale === 'id' 
        ? "Bagaimana kalkulator anggaran renovasi ini menghitung biaya perkiraan?" 
        : "How does the home renovation calculator estimate my costs?",
      answer: locale === 'id'
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF5] py-12 px-6">
      <UnifiedStructuredData
        currentUrl={`${baseUrl}/${locale}/home-living/budget-renovator`}
        pageTitle={locale === 'id' ? 'Kalkulator Anggaran Renovasi' : 'Home Renovation Budget Calculator'}
