...
export async function generateMetadata({ 
  ...
  return {
    title: locale === 'id' ? 'Buku Tamu Komunitas | LifeBloom Hub' : 'Community Support Guestbook | LifeBloom Hub',
...
export default async function GuestbookPage({
  ...
  const guestbookSchema = {
    ...
    '@type': 'WebPage',
    name: locale === 'id' ? 'Buku Tamu Komunitas LifeBloom Hub' : 'LifeBloom Hub Community Support Guestbook',
