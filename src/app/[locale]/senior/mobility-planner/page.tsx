...
export default async function MobilityPlannerPage({
  ...
  const faqItems = [
    {
      question: locale === 'id' 
        ? "Bagaimana alat audit mobilitas ini membantu pencegahan cedera di rumah?" 
        : "How does this home mobility auditor help prevent domestic injuries?",
      answer: locale === 'id'
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF5] py-12 px-6">
      <UnifiedStructuredData
        ...
        pageTitle={locale === 'id' ? 'Panduan Mobilitas Lansia' : 'Senior Mobility Safety Planner'}
