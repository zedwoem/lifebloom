...
export default async function DrugCheckerPage({
  ...
  const faqItems = [
    {
      question: locale === 'id' 
        ? "Bagaimana cara kerja alat pengecek interaksi obat ini?" 
        : "How does the prescription drug interaction checker work?",
      answer: locale === 'id'
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF5] py-12 px-6">
      <UnifiedStructuredData
        ...
        pageTitle={locale === 'id' ? 'Alat Pengecek Interaksi Obat' : 'Prescription Drug Checker'}
