      ...
      <div className="container mx-auto px-gutter-mobile md:px-margin-desktop pt-10 max-w-container-max relative z-10 animate-fade-in">
        ...
        <header className="mb-12 max-w-article-max">
          ...
          <p className="text-body-lg text-on-surface-variant leading-relaxed">
            Traveling should be a joy for everyone. Discover accessible destinations, plan barrier-free itineraries, and map out comfortable budgets so you can focus on making memories.
          </p>
        </header>

        {/* Above-the-fold Interactive Widgets */}
        <section className="w-full max-w-4xl mx-auto space-y-8 mb-12 animate-fade-in">
          <div id="trip-planner" className="bg-white rounded-3xl p-8 border border-border soft-shadow transition-all duration-300">
            <AccessibleTripPlanner />
          </div>
          <div id="trip-budget" className="bg-white rounded-3xl p-8 border border-border soft-shadow transition-all duration-300">
            <TripBudgetPlanner />
          </div>
        </section>
